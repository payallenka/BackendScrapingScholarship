"""Scraper for opportunitiescorners.com — WordPress-based."""
...
SITE_NAME = "Opportunities Corners"
...
class OpportunitiesCornersScraper(BaseScraper):
    ...
    def scrape(self) -> List[NormalizedScholarship]:
        ...
        while page <= self.max_pages:
            data = self.get_json(WP_API, params={
    ...
    def _parse_post(self, post: dict) -> NormalizedScholarship | None:
